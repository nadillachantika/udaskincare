...
class CompletedPengirimanPage extends StatefulWidget {
  ...
  const CompletedPengirimanPage(this.tabController, {Key key})
      : super(key: key);

  @override
  _CompletedPengirimanPageState createState() =>
      _CompletedPengirimanPageState();
}

class _CompletedPengirimanPageState extends State<CompletedPengirimanPage> {
  int difference;
